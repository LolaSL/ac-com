...
var data = {
  users: [{
    ...
    password: _bcryptjs["default"].hashSync('7777777'),
    isAdmin: true
  }, {
    name: 'Jane',
    email: 'user_doe@example.com',
    password: _bcryptjs["default"].hashSync('123'),
    isAdmin: false
  }, {
    name: 'Janny',
    email: 'user_jen@example.com',
    password: _bcryptjs["default"].hashSync('1234'),
    isAdmin: false
  }, {
    name: 'Manny',
    email: 'user_manny@example.com',
    password: _bcryptjs["default"].hashSync('1235'),
    isAdmin: false
  }, {
    name: 'Barny',
    email: 'user_ban@example.com',
    password: _bcryptjs["default"].hashSync('1236'),
    isAdmin: false
  }, {
    name: 'Mikky',
    email: 'user_mik@example.com',
    password: _bcryptjs["default"].hashSync('1237'),
    isAdmin: false
  }, {
    name: 'Polly',
    email: 'user_pol@example.com',
    password: _bcryptjs["default"].hashSync('1238'),
    isAdmin: false
  }, {
    name: 'Billy',
    email: 'user_bil@example.com',
    password: _bcryptjs["default"].hashSync('1239'),
    isAdmin: false
  }, {
    name: 'Milly',
    email: 'user_mil@example.com',
    password: _bcryptjs["default"].hashSync('1231'),
    isAdmin: false
  }, {
    name: 'Molly',
    email: 'user_mol@example.com',
    password: _bcryptjs["default"].hashSync('12312'),
    isAdmin: false
  }, {
    name: 'Coll',
    email: 'user_col@example.com',
    password: _bcryptjs["default"].hashSync('12314'),
    isAdmin: false
  }, {
    name: 'Fanny',
    email: 'user_fan@example.com',
    password: _bcryptjs["default"].hashSync('12315'),
    isAdmin: false
  }, {
    name: 'Danny',
    email: 'user_dan@example.com',
    password: _bcryptjs["default"].hashSync('12316'),
    isAdmin: false
  }],
  products: [{
    ...
    features: ['Energy Saving', 'Remote Control', "Anti-Bacteria Filter", "Dust Filter", "Fast Cooling", "Dual Sensing", "Anti Corrosion Gold Fin™", "Auto Restart", "Smart Operation"],
    mode: ["Cooling Mode", " Drying Mode ", "Fan Mode", "Silent Mode"],
    btu: 10000,
    areaCoverage: 25,
    energyEfficiency: 12,
    dimension: {
    ...
    features: ['Energy Saving', 'Remote Control', "Long-life Ion Deodorisation Filter", "Apple-Catechin Filter", "Fast Cooling", "Dual Sensing", "Anti Corrosion Gold Fin™", "Auto Restart", "Program Timer", "Smart Operation", "Automatic Air Flow Adjustment", "Economy Mode", "Washable Panel"],
    mode: ["Cooling Mode", " Drying Mode ", "Fan Mode", "Silent Mode"],
    btu: 10000,
    areaCoverage: 15,
    energyEfficiency: 10,
    ...
    features: ['Heating', 'Cooling', 'Wi-Fi embedded', 'Energy Saving', 'Remote Control', 'Led', 'Smart Things', "Anti-Bacteria Filter", "Dust Filter", "Motion Sensor"],
    mode: ["Cooling Mode", " Drying Mode ", "Fan Mode", "Silent Mode"],
    btu: 20000,
    areaCoverage: 48,
    ...
    features: ['Heating', 'Cooling', 'Wi-Fi', 'Energy Saving', 'Remote Control', 'Led', 'Smart Things', "Anti-Bacteria Filter", "Dust Filter", "Smart Operation"],
    mode: ["Cooling Mode", " Drying Mode ", "Fan Mode", "Silent Mode"],
    btu: 22000,
    areaCoverage: 50,
    energyEfficiency: 12,
    ...
    features: ['Energy Saving', 'Remote Control', "Cold catalyst filter", "Three-speed fan", "Dual Sensing", "Auto Restart", "Smart Operation", "Humidity control"],
    mode: ["Cooling Mode", " Drying Mode ", "Fan Mode", "Silent Mode", "Self-cleaning"],
    btu: 36000,
    areaCoverage: 85,
    energyEfficiency: 12,
    dimension: {
    ...
    documents: [{
      url: "https://surpluscityliquidators.com/cdn/shop/files/15Y50-SPEC-SHEET.pdf?v=15284594859896181523",
      type: "PDF",
      description: "User Manual for 96000 BTU VRF Heat Recovery"
    }, {
      url: "https://surpluscityliquidators.com/cdn/shop/files/15Y50-SPEC-SHEET.pdf?v=15284594859896181523",
      type: "PDF",
      description: "Technical Specifications for 96000 BTU VRF Heat Recovery"
    }, {
      url: "https://tech.lennoxintl.com/C03e7o14l/VIu12Ch2uV/507884-05.pdf",
      type: "Image",
      description: "Installation Guide Image"
    ...
    documents: [{
      url: "https://surpluscityliquidators.com/cdn/shop/files/15Y50-SPEC-SHEET.pdf?v=15284594859896181523",
      type: "PDF",
      description: "User Manual for 120000 BTU VRF Heat Recovery Multi-Split DC Inverter Outdoor Unit"
    }, {
      url: "https://surpluscityliquidators.com/cdn/shop/files/15Y50-SPEC-SHEET.pdf?v=15284594859896181523",
      type: "PDF",
      description: "Technical Specifications for 120000 BTU VRF Heat Recovery Multi-Split DC Inverter Outdoor Unit"
    }, {
      url: "https://tech.lennoxintl.com/C03e7o14l/VIu12Ch2uV/507884-05.pdf",
      type: "Image",
      description: "Installation Guide Image"
  ...
  serviceProviders: [{
    ...
    password: _bcryptjs["default"].hashSync('12345', 8),
    ...
    password: _bcryptjs["default"].hashSync('test2company', 8),
    typeOfProvider: 'design',
    phone: '1234567890',
    company: 'test2',
    experience: 7,
    ...
    password: _bcryptjs["default"].hashSync('test3company', 8),
    ...
    password: _bcryptjs["default"].hashSync('test4company', 8),
    typeOfProvider: 'Architecting',
    phone: '1234567934',
    company: 'test4',
    experience: 9,
    ...
    password: _bcryptjs["default"].hashSync('test5company', 8),
  ...
  blogs: [{
    ...
    image: "https://aws-obg-image-lb-1.tcl.com/content/dam/brandsite/global/images-for-blog/what-is-a-btu-pc.jpg?t=1705398665887&w=2560"
  }, {
