...
const data = {
  ...
  {
    name: "3/6ft Air Conditioner Drain Hose Split",
    model: "3/6ft-AC-DRAIN-HOSE",
    slug: "3-6ft-air-conditioner-drain-hose-split",
    category: "Drainage",
    image: "/images/ac-drain-hose.jpg",
    price: 3.17,
    discount: 0,
    countInStock: 180,
    brand: "PipePro",
    rating: 4.5,
    numReviews: 215,
    description: "Complete 3/6ft Air Conditioner Drain Hose Split Casement Drain Kits Extension Hose Connector Condensate Water Tubes Joint. Includes 3/6ft of pipe, elbows, connectors, and mounting clips.",
    features: "3/6ft length, Complete fittings set, UV resistant, Mounting clips included, Easy to cut and fit",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
    dimension: { width: 6, height: 0, depth: 0 },
    documents: []
  },
  {
    name: "Water Level Float Switch",
    model: "Wt-SAFETY-AC",
    slug: "water-level-float-switch",
    category: "Drainage",
    ...
    rating: 4.8,
    numReviews: 142,
    description: "Safety Water Level Float Switch shuts off AC unit when drain line is clogged. Prevents water damage from overflow. Easy to install in drain pan.",
    features: "Automatic shutoff, Prevents overflow, Easy installation, Normally closed contacts, Universal fit",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
    dimension: { width: 100, height: 0, depth: 0 },
    documents: []
  },
  ...
  // ========== Electrical Products ==========
  {
    ...
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
    dimension: { width: 8, height: 10, depth: 6.5 },
    documents: []
  },
  {
  ...
  {
    name: "Three Phase Voltage Protector",
    model: "TPV-53V",
    slug: "ac-three-phase-voltage-protector",
    category: "Electrical",
    image: "/images/3-phase-voltage-protector.jpg",
    price: 115,
    discount: 50,
    countInStock: 85,
    brand: "Taxmele",
    rating: 4.9,
    numReviews: 234,
    description: "Three Phase Adjustable Over and Under Voltage Protector 3 Phase Automatic Recovery Protective Device Reset 63A 380V. Protects against voltage spikes and power surges. Easy installation at disconnect box.",
    features: "Reset 63A 380V, LED indicator, Weatherproof housing, Easy installation, Protects electronics",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
    dimension: { width: 9.1, height: 9, depth: 5 },
    documents: []
  },
  // ========== Accessories ==========
  {
    name: "Smart Home Air Conditioner Modbus",
    model: "0-10V24VAC95-240VAC",
    slug: "smart-home-air-conditioner-modbus",
  ...
  },
  {
    ...
    rating: 4.3,
    numReviews: 412,
    description: "Universal AC Remote Control - 6000 in 1 LCD A/C Conditioning Controller for Multiple Brands Including Mitsubishi, Toshiba, Hitachi, Fujitsu, Daewoo, LG, Samsung, Electrolux, Sanyo, and AUX",
    features: "6000 in 1 models supported, LCD display, Temperature display, Timer function, Sleep mode",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
  ...
  // ========== Consumables ==========
  {
    ...
    rating: 4.8,
    numReviews: 89,
    description: "R410 refrigerant gas for air conditioning and refrigeration systems. Suitable for professional use by air conditioning technicians. Designed for filling and maintaining R410 systems. Efficient solution for service and installations.",
  ...
  {
    name: "Silicone Sealant for HVAC (750ml tube)",
    model: "SEAL-HVAC-290",
    ...
    rating: 4.5,
    numReviews: 176,
    description: "Silicone-based insulating lubricant designed as a sealing and insulating material to prevent the formation of a layer of water or dirt on parts. Easy to apply by applying with a cloth or brush. Does not contain hazardous materials or strong solvents. Suitable for sealing gaps in AC units, preventing leaks, and providing insulation.",
    features: "Weather-resistant, Paintable, 750ml tube, Mold resistant, Temperature stable",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
    dimension: { width: 10, height: 30, depth: 0 },
    documents: []
  },
  // ========== Spare Parts ==========
  {
    name: "AC Run Capacitor 40+5 MFD",
    model: "CBB65B",
    ...
    rating: 4.7,
    numReviews: 267,
    description: "Dual run capacitor for AC compressor and fan motor. 40+5 uF 40/5 MFD ±6% 370V/440VAC CBB65 Dual Run Circular Start Capacitor for AC Motor Run or Fan Start or Condenser Straight Universal replacement for most residential units.",
    features: "40+5 MFD rating, 370V, Dual run, Metal case, Universal fit",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
  ...
  {
    name: "Contactor Relay 25A 220VDC Coil",
    model: "LC1DT40MD",
    slug: "contactor-relay-25a-220vdc-coil",
    category: "Spare Parts",
    ...
    rating: 4.8,
    numReviews: 156,
    description: "Heavy-duty contactor relay for AC compressor control. Power contactor 4-pole, 1NO, 1NC - Magnet contactor 25A 220VDC LC1DT40MD. 25A rating, 220VDC coil. Replaces worn or failed contactors.",
    features: "25A contacts, 220VDC coil, Silver alloy contacts, DIN rail mount, High cycle life",
    btu: 0,
    numberOfMaximumIndoorUnits: 0,
  ...
  {
    name: "PCB Control Board Split System AC",
    model: "QD-U08C",
    slug: "ac-QD-U08C-control-board",
    category: "Spare Parts",
