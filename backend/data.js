...
const data = {
  ...
  products: [
    ...
    {
  name: "70000 BTU Multi-System Condenser",
  model: "LMU701HV",
  slug: "70000-mini-split-outdoor-condensing-unit",
  category: "Outdoor Condenser",
  image: "/images/p21.jpg",  // Use an appropriate image
  price: 8500,  // Adjust price as needed
  discount: 5,
  countInStock: 5,
  brand: "LG",
  rating: 4.5,
  numReviews: 25,
  description: "70000 BTU Class Multi-System Ductless Split Outdoor Unit for larger applications.",
  features: "Energy Saving, Inverter Technology",
  btu: 70000,
 ...
 documents: [
        {
          url: "https://files.lghvac.com/resources//IM_MultiV_S_OutdoorUnits.pdf",
          type: "PDF",
          description: "User Manual for Mini Split Outdoor Condenser",
        },
        {
        ...
        {
          url: "https://s1.img-b.com/build.com/mediabase/specifications/lg/1759161/lg-l4l36f09090912-installation-sheet.pdf",
          type: "Image",
          description: "Installation Guide Image",
        },
      ],
  ...
  rating: 4.5,
  numReviews: 25,
  description: "80000 BTU Class Multi-System Ductless Split Outdoor Unit for larger applications.",
  features: "Energy Saving, Inverter Technology",
  btu: 80000,
  numberOfMaximumIndoorUnits: 10,
  dimension: {
