      ...
      >
        ...
        >
          <Nav className="flex-column text-white w-100 p-4">
            <Nav.Item className="text-white mb-2">
              <Link to="/" className="nav-link-side fw-bold ">
                Home
              </Link>
            </Nav.Item>
            <Nav.Item className="search-title me-auto mb-2">
              <Link to="/about-us" className="nav-link-side fw-bold mb-2">
                About Us
              </Link>
            </Nav.Item>
            <Nav.Item className="nav-link me-auto fw-bold mb-2">
              <NavDropdown
                title={<strong>Categories</strong>}
            ...
            <Nav.Item className="search-title me-auto">
              <Link to="/offers" className="nav-link-side fw-bold">
                Offers
              </Link>
            </Nav.Item>
            <Nav.Item className="search-title me-auto">
              <Link to="/sellers" className="nav-link-side fw-bold">
                Explore Suppliers
              </Link>
            </Nav.Item>
            <Nav.Item className="search-title me-auto">
