  ...
  return (
    <Container className="my-5">
      ...
      <ul className="custom-ul">
        ...
        <li className="fs-5">
          Items must be returned within 20 days of receipt.
        </li>
        <li className="fs-5">
          An RMA (Return Merchandise Authorization) number is required for all
          returns.
        </li>
        <li className="fs-5">
      ...
      <p className="fs-5">
        ...
        <strong>(630) 446 8851</strong> to request authorization for these
        returns.
      </p>
      ...
      <ul className="custom-ul">
        <li className="fs-5">
          Verify that the product meets the return requirements above.
        </li>
        <li className="fs-5">
          Contact us to obtain an RMA number. Returns without a valid RMA number
          will be refused.
        </li>
