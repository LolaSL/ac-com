...
const handlePrint = async () => {
  try {
    ...
    console.log("handlePrint checking isPaid:", isPaid, typeof isPaid, "->", paid);
  ...
  return (
<Button variant="danger" className="p-1"  onClick={handlePrint} > <i className="fas fa-print"></i> Print</Button>
  );
};
